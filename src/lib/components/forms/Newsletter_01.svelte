        ...
        <div class="gap-16 justify-between items-center p-6 text-white bg-gray-900 rounded-lg dark:bg-gray-800 lg:flex lg:gap-24 md:p-12">
            ...
            <div class="mt-6 w-full lg:mt-0">
                <form action="#">
                    ...
                    <div class="text-sm text-left text-gray-400 dark:text-gray-300">We care about the protection of your data. <a href="/privacy-policy" class="font-medium text-white hover:underline">Read our Privacy Policy</a>.</div>
                </form>
            </div>
        </div>
    </div>
