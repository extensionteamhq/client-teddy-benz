...
{#if isOpen}
    <div role="dialog" class="modal">
        <div class="contents relative">
            ...
            <div class="fixed left-0 top-0 z-[1055] h-full w-full overflow-y-auto overflow-x-hidden outline-none" class:hidden={$isLoading} transition:fade|global>
                <!-- Ensure this container takes full height minus any desired margins/padding -->
                <div class="pointer-events-auto relative flex w-full flex-col bg-neutral-100 dark:bg-neutral-900 bg-clip-padding text-neutral-900 dark:text-neutral-100 shadow-4 outline-none h-full">
                    <!-- Modal Header -->
                    ...
                    <div class="relative overflow-y-auto h-full">
                        <iframe 
                            src="https://calendly.com/add-your-calendly-path/add-your-calendly-event?embed_domain=1" 
                            title="add-your-calendly-title"
                            frameborder="0"
