...
<section id="about" class="py-8 lg:py-16 my-10 text-center">
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl sm:text-center">
        ...
        <p class="sm:text-xl text-center"
            >Explore how my unique insights and steadfast support can turn your challenges into victories. Dive into my story to discover how you can tailor the
            narrative to fit your personal goals and dreams.</p>
    ...
    <div class="text-center w-full">
        <button type="button" data-twe-ripple-init class="mt-14 mx-4" on:click={handleConnect}
            >Let's Connect
