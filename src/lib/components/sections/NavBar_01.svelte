...
<header class="z-50 absolute top-0 left-0 right-0">
    ...
    <nav
        class="fixed top-0 flex w-full flex-wrap items-center justify-between shadow-lg shadow-neutral-300 dark:shadow-neutral-600 text-neutral-900 bg-neutral-100 dark:text-neutral-100 dark:bg-neutral-900"
        aria-label="Global">
        <!-- info banner -->
