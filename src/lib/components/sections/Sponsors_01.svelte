    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl sm:text-center">
        ...
        <div class="space-y-4 sm:grid grid-cols-2 sm:gap-4 xl:gap-8 sm:space-y-0 md:mb-8 md:mt-12">
            <a
                ...
                <svg class="mx-auto h-14 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 779.5 779.5" xml:space="preserve"
                    ><path
                        fill="#FFCB31"
                ...
                <p class="font-light mt-3.5 mb-4">Marketing Solutions To Reach Your Target Audience and Expand Your Brand. Their An Extension To Your Team.</p>
            </a>
            <a
