...
<div class="px-6 py-32 lg:px-8 mt-20">
    <div class="mx-auto max-w-3xl text-base leading-7">
        ...
        <div class="grid grid-cols-2 grid-rows-1 mb-8 gap-x-10">
            <!-- name, title, company -->
            <div>
                {#if layoutConfig.site.titleName != '' || layoutConfig.site.firstName != '' || layoutConfig.site.middleName != '' || layoutConfig.site.lastName != '' || layoutConfig.site.suffixName != ''}
                ...
                {/if}
                {#if layoutConfig.site.nickName != '' || layoutConfig.site.orgName != ''}
                    <p class="mt-1 mb-0">
